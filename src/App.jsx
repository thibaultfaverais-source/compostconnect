...
const DEFAULT_SITES = [
  ...
  {id: "s19", name: "Chissay-en-Touraine", address: "Commune de Chissay-en-Touraine, 41400", code: "CHISSA", foyers: 0, typeSite: "En cours", cantine: "Non concerné", periode: "", capacityL: 400, referents: [{role: "Référent technique", nom: "Christophe BOUTET", tel: "07 86 03 46 58", email: "riochantal@orange.fr"}, {role: "Elu référent", nom: "Jean-Hervé BOYER", tel: "07 86 03 46 58", email: "gillespelle@laposte.net"}, {role: "Responsable cuisine", nom: "Magali BAK", tel: "", email: ""}], biodechets_kg: 808, compost_L: 450, pointsForts: [], pointsAmelioration: [], conclusion: "", lat: 47.3381, lng: 1.1339},
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 21, fontWeight: 700, color: C.text }}>
                {step === 1 ? (editEntry ? "✏️ Modifier la saisie" : "Nouvelle saisie") : `${selectedAction?.icon} ${selectedAction?.label}`}
              </h2>
...
export default function App() {
  ...
  const addEntry = async (entryData) => {
    const isEdit = !!entryData.isEdit;
    const newEntry = isEdit 
